module.exports = {  // export module
  keywords: { // keywords
    ...
    deposit: [  // deposit identified by keywords
      'الإيداع',
      'الاستلام',
      'العنوان',
      'العناوين',
    ...
    settings: [ // settings identified by keywords
      'الإعدادات',
      'الإعداد',
      'الحساب',
      'الحسابات',
    ...
    menu: [ // menu identified by keywords
      'القائمة',
      'المساعدة',
      'الخيارات',
      'كيف',
    ...
    support: [  // support identified by keywords
      'دعم',
      'زبون',
      'خدمة',
      'مساعدة',
  ...
  daily: {  // daily
    ...
    content: '🤑 لقد تلقيت تحويلاً من {{1}} بمبلغ {{2}}. الرصيد الجديد هو {{3}}' // content message
  },
  deposited: {  // deposited
    type: 'template', // type
  ...
  update: { // update
    type: 'template', // type
    name: 'go_onboard', // name
    content: '✋ تم تحديث إعداداتك. لتهيئة الإعدادات المتقدمة ، انقر هنا: {{1}}'  // content message
  },
