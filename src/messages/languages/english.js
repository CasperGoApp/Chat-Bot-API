module.exports = {
  ...
  keywords: {
    ...
    settings: [
      // settings keywords identified similarly in context
  ...
  stopProcess: [
    // stopProcess identified by keywords
    'cancel', // cancel
    'stop', // stop
    'exit', // exit
    'quit', // quit
